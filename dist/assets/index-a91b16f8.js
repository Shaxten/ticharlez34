 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SL={["no-app"]:"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance."},Vy=new Bi("app-compat","Firebase",SL);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N0(){const n=CL(TL);n.INTERNAL=Object.assign(Object.assign({},n.INTERNAL),{createFirebaseNamespace:N0,extendNamespace:e,createSubscribe:Xv,ErrorFactory:Bi,deepExtend:Kc});function e(t){Kc(n,t)}return n}const kL=N0();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const By=new Ou("@firebase/app-compat"),AL="@firebase/app-compat",RL="0.2.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */if(LS()&&self.firebase!==void 0){By.warn(`
  ...
  `);const n=self.firebase.SDK_VERSION;n&&n.indexOf("LITE")>=0&&By.warn(`
    ...
    `)}const so=kL;xL();var NL="firebase",DL="9.22.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */so.registerVersion(NL,DL,"app-compat");const PL="@firebase/firestore-compat",OL="0.3.9";/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gd(n){return ML(n,["next","error","complete"])}function ML(n,e){if(typeof n!="object"||n===null)return!1;const t=n;for(const r of e)if(r in t&&typeof t[r]=="function")return!0;return!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VL={Firestore:D0,GeoPoint:Il,Timestamp:Be,Blob:Ia,Transaction:P0,WriteBatch:O0,DocumentReference:on,DocumentSnapshot:ba,Query:Mt,QueryDocumentSnapshot:Ea,QuerySnapshot:yd,CollectionReference:Bs,FieldPath:$p,FieldValue:hi,setLogLevel:FL,CACHE_SIZE_UNLIMITED:JO};function BL(n,e){n.INTERNAL.registerComponent(new Bn("firestore-compat",t=>{const r=t.getProvider("app-compat").getImmediate(),i=t.getProvider("firestore").getImmediate();return e(r,i)},"PUBLIC").setServiceProps(Object.assign({},VL)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $L(n){BL(n,(e,t)=>new D0(e,t,new LL)),n.registerVersion(PL,OL)}$L(so);/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qL=2e3;async function jL(n,e,t){var r;const{BuildInfo:i}=Vi();mn(e.sessionId,"AuthEvent did not contain a session ID");const s=await WL(e.sessionId),o={};return Gs()?o.ibi=i.packageName:Ca()?o.apn=i.packageName:ht(n,"operation-not-supported-in-this-environment"),i.displayName&&(o.appDisplayName=i.displayName),o.sessionId=s,xh(n,t,e.type,void 0,(r=e.eventId)!==null&&r!==void 0?r:void 0,o)}async function zL(n){const{BuildInfo:e}=Vi(),t={};Gs()?t.iosBundleId=e.packageName:Ca()?t.androidPackageName=e.packageName:ht(n,"operation-not-supported-in-this-environment"),await t_(n,t)}function KL(n){const{cordova:e}=Vi();return new Promise(t=>{e.plugins.browsertab.isAvailable(r=>{let i=null;r?e.plugins.browsertab.openUrl(n):i=e.InAppBrowser.open(n,_k()?"_blank":"_system","location=yes"),t(i)})})}async function GL(n,e,t){const{cordova:r}=Vi();let i=()=>{};try{await new Promise((s,o)=>{let a=null;function c(){var h;s();const d=(h=r.plugins.browsertab)===null||h===void 0?void 0:h.close;typeof d=="function"&&d(),typeof(t==null?void 0:t.close)=="function"&&t.close()}function u(){a||(a=window.setTimeout(()=>{o(_t(n,"redirect-cancelled-by-user"))},qL))}function l(){(document==null?void 0:document.visibilityState)==="visible"&&u()}e.addPassiveListener(c),document.addEventListener("resume",u,!1),Ca()&&document.addEventListener("visibilitychange",l,!1),i=()=>{e.removePassiveListener(c),document.removeEventListener("resume",u,!1),document.removeEventListener("visibilitychange",l,!1),a&&window.clearTimeout(a)}})}finally{i()}}function HL(n){var e,t,r,i,s,o,a,c,u,l;const h=Vi();F(typeof((e=h==null?void 0:h.universalLinks)===null||e===void 0?void 0:e.subscribe)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-universal-links-plugin-fix"}),F(typeof((t=h==null?void 0:h.BuildInfo)===null||t===void 0?void 0:t.packageName)<"u",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-buildInfo"}),F(typeof((s=(i=(r=h==null?void 0:h.cordova)===null||r===void 0?void 0:r.plugins)===null||i===void 0?void 0:i.browsertab)===null||s===void 0?void 0:s.openUrl)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),F(typeof((c=(a=(o=h==null?void 0:h.cordova)===null||o===void 0?void 0:o.plugins)===null||a===void 0?void 0:a.browsertab)===null||c===void 0?void 0:c.isAvailable)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),F(typeof((l=(u=h==null?void 0:h.cordova)===null||u===void 0?void 0:u.InAppBrowser)===null||l===void 0?void 0:l.open)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-inappbrowser"})}async function WL(n){const e=QL(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(i=>i.toString(16).padStart(2,"0")).join("")}function QL(n){if(mn(/[0-9a-zA-Z]+/.test(n),"Can only convert alpha-numeric strings"),typeof TextEncoder<"u")return new TextEncoder().encode(n);const e=new ArrayBuffer(n.length),t=new Uint8Array(e);for(let r=0;r<n.length;r++)t[r]=n.charCodeAt(r);return t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YL=20;class JL extends Zw{constructor(){super(...arguments),this.passiveListeners=new Set,this.initPromise=new Promise(e=>{this.resolveInialized=e})}addPassiveListener(e){this.passiveListeners.add(e)}removePassiveListener(e){this.passiveListeners.delete(e)}resetRedirect(){this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1}onEvent(e){return this.resolveInialized(),this.passiveListeners.forEach(t=>t(e)),super.onEvent(e)}async initialized(){await this.initPromise}}function XL(n,e,t=null){return{type:e,eventId:t,urlResponse:null,sessionId:tF(),postBody:null,tenantId:n.tenantId,error:_t(n,"no-auth-event")}}function ZL(n,e){return vd()._set(wd(n),e)}async function jy(n){const e=await vd()._get(wd(n));return e&&await vd()._remove(wd(n)),e}function eF(n,e){var t,r;const i=rF(e);if(i.includes("/__/auth/callback")){const s=Uc(i),o=s.firebaseError?nF(decodeURIComponent(s.firebaseError)):null,a=(r=(t=o==null?void 0:o.code)===null||t===void 0?void 0:t.split("auth/"))===null||r===void 0?void 0:r[1],c=a?_t(a):null;return c?{type:n.type,eventId:n.eventId,tenantId:n.tenantId,error:c,urlResponse:null,sessionId:null,postBody:null}:{type:n.type,eventId:n.eventId,tenantId:n.tenantId,sessionId:n.sessionId,urlResponse:i,postBody:null}}return null}function tF(){const n=[],e="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";for(let t=0;t<YL;t++){const r=Math.floor(Math.random()*e.length);n.push(e.charAt(r))}return n.join("")}function vd(){return Yt($u)}function wd(n){return Ii("authEvent",n.config.apiKey,n.name)}function nF(n){try{return JSON.parse(n)}catch{return null}}function rF(n){const e=Uc(n),t=e.link?decodeURIComponent(e.link):void 0,r=Uc(t).link,i=e.deep_link_id?decodeURIComponent(e.deep_link_id):void 0;return Uc(i).link||i||r||t||n}function Uc(n){if(!(n!=null&&n.includes("?")))return{};const[e,...t]=n.split("?");return ss(t.join("?"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iF=500;class sF{constructor(){this._redirectPersistence=Pr,this._shouldInitProactively=!0,this.eventManagers=new Map,this.originValidationPromises={},this._completeRedirectFn=Ku,this._overrideRedirectResult=pf}async _initialize(e){const t=e._key();let r=this.eventManagers.get(t);return r||(r=new JL(e),this.eventManagers.set(t,r),this.attachCallbackListeners(e,r)),r}_openPopup(e){ht(e,"operation-not-supported-in-this-environment")}async _openRedirect(e,t,r,i){HL(e);const s=await this._initialize(e);await s.initialized(),s.resetRedirect(),v1(),await this._originValidation(e);const o=XL(e,r,i);await ZL(e,o);const a=await jL(e,o,t),c=await KL(a);return GL(e,s,c)}_isIframeWebStorageSupported(e,t){throw new Error("Method not implemented.")}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=zL(e)),this.originValidationPromises[t]}attachCallbackListeners(e,t){const{universalLinks:r,handleOpenURL:i,BuildInfo:s}=Vi(),o=setTimeout(async()=>{await jy(e),t.onEvent(zy())},iF),a=async l=>{clearTimeout(o);const h=await jy(e);let d=null;h&&(l!=null&&l.url)&&(d=eF(h,l.url)),t.onEvent(d||zy())};typeof r<"u"&&typeof r.subscribe=="function"&&r.subscribe(null,a);const c=i,u=`${s.packageName.toLowerCase()}://`;Vi().handleOpenURL=async l=>{if(l.toLowerCase().startsWith(u)&&a({url:l}),typeof c=="function")try{c(l)}catch(h){console.error(h)}}}}const oF=sF;function zy(){return{type:"unknown",eventId:null,sessionId:null,urlResponse:null,postBody:null,tenantId:null,error:_t("no-auth-event")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aF(n,e){Ye(n)._logFramework(e)}var cF="@firebase/auth-compat",uF="0.4.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lF=1e3;function Ko(){var n;return((n=self==null?void 0:self.location)===null||n===void 0?void 0:n.protocol)||null}function hF(){return Ko()==="http:"||Ko()==="https:"}function F0(n=je()){return!!((Ko()==="file:"||Ko()==="ionic:"||Ko()==="capacitor:")&&n.toLowerCase().match(/iphone|ipad|ipod|android/))}function dF(){return Gd()||Kd()}function fF(){return Jv()&&(document==null?void 0:document.documentMode)===11}function pF(n=je()){return/Edge\/\d+/.test(n)}function mF(n=je()){return fF()||pF(n)}function U0(){try{const n=self.localStorage,e=Aa();if(n)return n.setItem(e,"1"),n.removeItem(e),mF()?Xo():!0}catch{return qp()&&Xo()}return!1}function qp(){return typeof global<"u"&&"WorkerGlobalScope"in global&&"importScripts"in global}function hh(){return(hF()||Yv()||F0())&&!dF()&&U0()&&!qp()}function V0(){return F0()&&typeof document<"u"}async function gF(){return V0()?new Promise(n=>{const e=setTimeout(()=>{n(!1)},lF);document.addEventListener("deviceready",()=>{clearTimeout(e),n(!0)})}):!1}function yF(){return typeof window<"u"?window:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt={LOCAL:"local",NONE:"none",SESSION:"session"},Io=F,B0="persistence";function vF(n,e){if(Io(Object.values(Qt).includes(e),n,"invalid-persistence-type"),Gd()){Io(e!==Qt.SESSION,n,"unsupported-persistence-type");return}if(Kd()){Io(e===Qt.NONE,n,"unsupported-persistence-type");return}if(qp()){Io(e===Qt.NONE||e===Qt.LOCAL&&Xo(),n,"unsupported-persistence-type");return}Io(e===Qt.NONE||U0(),n,"unsupported-persistence-type")}async function _d(n){await n._initializationPromise;const e=$0(),t=Ii(B0,n.config.apiKey,n.name);e&&e.setItem(t,n._getPersistence())}function wF(n,e){const t=$0();if(!t)return[];const r=Ii(B0,n,e);switch(t.getItem(r)){case Qt.NONE:return[Es];case Qt.LOCAL:return[Ss,Pr];case Qt.SESSION:return[Pr];default:return[]}}function $0(){var n;try{return((n=yF())===null||n===void 0?void 0:n.sessionStorage)||null}catch{return null}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _F=F;class Tr{constructor(){this.browserResolver=Yt(n_),this.cordovaResolver=Yt(oF),this.underlyingResolver=null,this._redirectPersistence=Pr,this._completeRedirectFn=Ku,this._overrideRedirectResult=pf}async _initialize(e){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._initialize(e)}async _openPopup(e,t,r,i){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._openPopup(e,t,r,i)}async _openRedirect(e,t,r,i){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._openRedirect(e,t,r,i)}_isIframeWebStorageSupported(e,t){this.assertedUnderlyingResolver._isIframeWebStorageSupported(e,t)}_originValidation(e){return this.assertedUnderlyingResolver._originValidation(e)}get _shouldInitProactively(){return V0()||this.browserResolver._shouldInitProactively}get assertedUnderlyingResolver(){return _F(this.underlyingResolver,"internal-error"),this.underlyingResolver}async selectUnderlyingResolver(){if(this.underlyingResolver)return;const e=await gF();this.underlyingResolver=e?this.cordovaResolver:this.browserResolver}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q0(n){return n.unwrap()}function IF(n){return n.wrapped()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bF(n){return j0(n)}function EF(n,e){var t;const r=(t=e.customData)===null||t===void 0?void 0:t._tokenResponse;if((e==null?void 0:e.code)==="auth/multi-factor-auth-required"){const i=e;i.resolver=new TF(n,TA(n,e))}else if(r){const i=j0(e),s=e;i&&(s.credential=i,s.tenantId=r.tenantId||void 0,s.email=r.email||void 0,s.phoneNumber=r.phoneNumber||void 0)}}function j0(n){const{_tokenResponse:e}=n instanceof Ut?n.customData:n;if(!e)return null;if(!(n instanceof Ut)&&"temporaryProof"in e&&"phoneNumber"in e)return Ai.credentialFromResult(n);const t=e.providerId;if(!t||t===lo.PASSWORD)return null;let r;switch(t){case lo.GOOGLE:r=kn;break;case lo.FACEBOOK:r=Cn;break;case lo.GITHUB:r=An;break;case lo.TWITTER:r=Rn;break;default:const{oauthIdToken:i,oauthAccessToken:s,oauthTokenSecret:o,pendingToken:a,nonce:c}=e;return!s&&!o&&!i&&!a?null:a?t.startsWith("saml.")?Ts._create(t,a):$n._fromParams({providerId:t,signInMethod:t,pendingToken:a,idToken:i,accessToken:s}):new fs(t).credential({idToken:i,accessToken:s,rawNonce:c})}return n instanceof Ut?r.credentialFromError(n):r.credentialFromResult(n)}function jt(n,e){return e.catch(t=>{throw t instanceof Ut&&EF(n,t),t}).then(t=>{const r=t.operationType,i=t.user;return{operationType:r,credential:bF(t),additionalUserInfo:_A(t),user:Xn.getOrCreate(i)}})}async function Id(n,e){const t=await e;return{verificationId:t.verificationId,confirm:r=>jt(n,t.confirm(r))}}class TF{constructor(e,t){this.resolver=t,this.auth=IF(e)}get session(){return this.resolver.session}get hints(){return this.resolver.hints}resolveSignIn(e){return jt(q0(this.auth),this.resolver.resolveSignIn(e))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CF=F;class kF{constructor(e,t,r=so.app()){var i;CF((i=r.options)===null||i===void 0?void 0:i.apiKey,"invalid-api-key",{appName:r.name}),this._delegate=new n1(e,t,r.auth()),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
